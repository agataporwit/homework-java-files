...
public class Date {
    ...
    /**
     * The setYear method verified if the variable year is within the range 1000 through 9999
    ...
    /**
     * The setMonth method verified if the variable monthNumber is within the range 1 through 12
    ...
    /**
     * The setDay method verified if the variable day is within the range 1 through 31
