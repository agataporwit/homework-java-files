...
/**
 *
 * @author agata jelen CSD 143 Winter 2018
 */
public class Fraction {
    ...
    public Fraction(int numerator, int denominator) {
        ...
        if (denominator == 0) {
            throw new IllegalArgumentException("Denominator can not be a 0");
        }
    }
     ...
     * object that is the sum of two fractions. 
     * Do not forget that in order to
